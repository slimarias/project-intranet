      ...
      <div class="relative-position col-12" v-if="success">
        ...
        >
          ...
          <template v-slot:body-cell="props">
            <!--Default columns-->
            <q-td v-if="props.col.name != 'actions'" :props="props" :title="props.value">
              {{props.value}}
            </q-td>
            <!-- actions columns -->
  ...
  export default {
    ...
    methods: {
            ...
            if (params.read.filterName || params.read.filters) {
              await this.$filter.setFilter({
                ...
                callBack: () => {
                  ...
                  this.getDataTable(false, this.$filter.values, this.$filter.pagination)
                }
              })
            }
          }
      ...
      getData({pagination, filter}, refresh = false) {
        ...
        params.params.filter = {...params.params.filter, ...filter}
