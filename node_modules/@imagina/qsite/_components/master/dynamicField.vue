  ...
  <div id="dynamicFieldComponent" class="relative-position" v-if="success">
    ...
    <div v-else>
      ...
      <q-field v-model="responseValue" v-if="loadField('html')" label="" class="field-no-padding"
               v-bind="fieldProps.fieldComponent">
        <q-editor v-model="responseValue" class="full-width" v-bind="fieldProps.field"/>
      </q-field>
      <!--multiSelect-->
      ...
      <!--Image-->
      <q-field v-model="responseValue" v-if="loadField('image')" label="" v-bind="fieldProps.fieldComponent">
...
<script>
  ...
  export default {
    ...
    components: {managePermissions, manageSettings, recursiveSelect, media, uploadImage, schedulesForm},
    watch: {
    ...
    methods: {
      ...
      orderOptions(propValue) {
        if (propValue != undefined) {
          ...
          } else this.responseValue = this.$clone(propValue.toString())
        }
      },
